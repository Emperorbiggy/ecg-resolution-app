...
export default function PaymentList({ payments, filters = {}, received_count = 0 }) {
    const [search, setSearch] = useState(filters.search || '');

    const applyFilters = (newSearch = search) => {
        router.get(route('accountant.payments'), {
            search: newSearch || undefined,
        }, { preserveState: true, replace: true });
    };

    return (
        <StaffLayout header="Pending Payments">
            <div className="space-y-4 animate-fade-in">
                ...
                <div className="flex gap-1 border-b border-slate-200 dark:border-slate-700">
                    ...
                    <Link
                        href={route('accountant.payments.received')}
                ...
                <PaymentTable
                    payments={payments}
                    detailRoute={(id) => route('accountant.payments.show', id)}
